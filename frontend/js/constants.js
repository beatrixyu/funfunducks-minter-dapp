...
const welcome_p = 'FunFunDucks Club is an NFT collection created by Bea M. Yu <a href="https://beatrixyu.github.io/bea-portfolio/" target="_blank" rel="noopener noreferrer">Bea M Yu</a> from Metropolis Shanghai, China, who works as a software developer and a social media content creator in Düsseldorf, Germany now. <br/> <br/>FunFunDucks is Hand-crafted + code generative crypto ducks, which is a hybrid with Repaper, Gimp, and Figma on the blockchain. This project is still in its early stages. Make sure to follow our social media accounts, especially <a href="https://www.instagram.com/funfunduckclub_nft/" target="_blank" rel="noopener noreferrer"> [Instagram] </a> and <a href="https://twitter.com/FunFunDuckClub" target="_blank" rel="noopener noreferrer"> [Twitter]  </a> so that we can apply for verification.';
